...
public class DamageReporterFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5608772310813649905L;
	...
	public DamageReporterFrame() {
		...
		carType.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				DamageReport.CarType item = carType.getItemAt(carType
						.getSelectedIndex());
		...
		carComponent = new JComponent() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 5950920441102951763L;
	...
	static {
		...
		Point2D.Double p8 = new Point2D.Double(x + width * 11 / 12, y - width
				/ 6);
