package epk.sam.ebooks.corejava9.v2.ch09.jaas;
...
/**
 * This frame has text fields for user name and password, a field for the name
 * of the requested system property, and a field to show the property value.
 */
public class JAASFrame extends JFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3551003132560187948L;
	...
	public JAASFrame() {
		...
		getValueButton.addActionListener(EventHandler.create(
				ActionListener.class, this, "getValue"));
