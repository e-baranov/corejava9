...
public class RenderQualityTestFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 69504452451033976L;
	...
	public RenderQualityTestFrame() {
		...
		makeButtons("KEY_ANTIALIASING", "VALUE_ANTIALIAS_OFF",
				"VALUE_ANTIALIAS_ON");
		...
		makeButtons("KEY_RENDERING", "VALUE_RENDER_SPEED",
				"VALUE_RENDER_QUALITY");
		makeButtons("KEY_STROKE_CONTROL", "VALUE_STROKE_PURE",
	...
	void makeButtons(String key, String value1, String value2) {
		try {
			final RenderingHints.Key k = (RenderingHints.Key) RenderingHints.class
			...
			buttonBox.add(label, new GBC2(0, r).setAnchor(GBC2.WEST));
			ButtonGroup group = new ButtonGroup();
			JRadioButton b1 = new JRadioButton(value1, true);

			buttonBox.add(b1, new GBC2(1, r).setAnchor(GBC2.WEST));
			group.add(b1);
			...
			buttonBox.add(b2, new GBC2(2, r).setAnchor(GBC2.WEST));
			group.add(b2);
...
class RenderQualityComponent extends JComponent {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2436414076568201816L;
