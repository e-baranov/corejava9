...
public class FormatTestFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 291699535154329013L;
	...
	public FormatTestFrame() {
		...
		JFormattedTextField intField3 = new JFormattedTextField(
			 ...
			 * 
			 */
					private static final long serialVersionUID = 8832297852945507150L;
			...
			public void actionPerformed(ActionEvent event) {
				...
				if (cl.isArray()) {
					if (cl.getComponentType().isPrimitive()) {
						try {
							text = Arrays.class.getMethod("toString", cl)
