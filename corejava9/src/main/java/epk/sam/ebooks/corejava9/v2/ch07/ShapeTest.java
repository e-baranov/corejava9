...
class ShapeTestFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4895977467004537622L;
	...
	public ShapeTestFrame() {
		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				ShapeMaker shapeMaker = comboBox.getItemAt(comboBox
						.getSelectedIndex());
...
class ShapeComponent extends JComponent {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8498992634724381209L;
