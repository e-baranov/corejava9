package epk.sam.ebooks.corejava9.v2.ch08;
...
public class FilePickerBean extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6354882827851804936L;
	...
	public FilePickerBean() {
		...
		dialogButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				chooser.setFileFilter(new FileNameExtensionFilter(Arrays
						.toString(extensions), extensions));
