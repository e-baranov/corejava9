package epk.sam.ebooks.corejava9.v2.ch02;
...
public class XMLWriteFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 337564993928298831L;
	...
	public XMLWriteFrame() {
		...
		menu.add(newItem);
		newItem.addActionListener(EventHandler.create(ActionListener.class,
				comp, "newDrawing"));
		...
		saveStAXItem.addActionListener(EventHandler.create(
				ActionListener.class, this, "saveStAX"));
	...
	public void saveStAX() throws IOException, XMLStreamException {
		...
		XMLStreamWriter writer = factory.createXMLStreamWriter(Files
