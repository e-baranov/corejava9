package epk.sam.ebooks.corejava9.v2.ch07.imageTransfer;
...
class ImageTransferFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8044110043056803411L;
	...
	public ImageTransferFrame() {
		...
		g.fillOval(IMAGE_WIDTH / 4, IMAGE_WIDTH / 4, IMAGE_WIDTH / 2,
				IMAGE_HEIGHT / 2);
