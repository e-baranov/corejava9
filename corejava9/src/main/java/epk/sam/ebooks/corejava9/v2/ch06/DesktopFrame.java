...
public class DesktopFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -9004012248336481822L;
	...
	public DesktopFrame() {
		...
		openItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				createInternalFrame(new JLabel(new ImageIcon(getClass()
						.getResource(planets[counter] + ".gif"))),
						planets[counter]);
	...
	public void createInternalFrame(Component c, String t) {
		...
		iframe.setFrameIcon(new ImageIcon(getClass()
				.getResource("document.gif")));
