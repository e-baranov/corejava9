...
public class ImageIOFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1251737951145503884L;
	...
	/**
	 * Gets a set of "preferred" format names of all image writers. The
	 * preferred format name is the first format name that a writer specifies.
	 * 
