...
/**
 * This frame has a text field for the banner text and buttons for printing,
...
public class BookTestFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 830404219100188032L;
	...
	public Book makeBook() {
		...
		int pageCount = banner.getPageCount((Graphics2D) getGraphics(),
				pageFormat);
