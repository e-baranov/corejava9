...
public class ColorTableCellEditor extends AbstractCellEditor implements
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5165594236942177879L;
	...
	public ColorTableCellEditor() {
		...
		colorDialog = JColorChooser.createDialog(null, "Planet Color", false,
				colorChooser, EventHandler.create(ActionListener.class, this,
						"stopCellEditing"), EventHandler.create(
						ActionListener.class, this, "cancelCellEditing"));
	}
