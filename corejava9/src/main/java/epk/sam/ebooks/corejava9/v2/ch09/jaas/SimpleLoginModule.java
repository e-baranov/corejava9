...
/**
 * This login module authenticates users by reading usernames, passwords, and
 * roles from a text file.
 */
public class SimpleLoginModule implements LoginModule {
	...
	/**
	 * Checks whether the authentication information is valid. If it is, the
	 * subject acquires principals for the user name and role.
	 * 
	 * @param username
	 *            the user name
	 * @param password
