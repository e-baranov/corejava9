package epk.sam.ebooks.corejava9.v1.ch11;
...
class ExceptTestFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1054530445907626209L;
...
class ExceptTestPanel extends Box {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2738020830751375198L;
	...
	public ExceptTestPanel() {
		...
		addRadioButton("No such file", new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				try {
					System.out.println(new Scanner(Paths.get("woozle.txt"))
							.next());
				} catch (IOException e) {
	...
	private void addRadioButton(String s, ActionListener listener) {
		JRadioButton button = new JRadioButton(s, false) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 478995131718415569L;
