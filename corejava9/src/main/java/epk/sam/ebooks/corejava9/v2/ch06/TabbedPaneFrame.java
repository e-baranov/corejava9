...
public class TabbedPaneFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2764238809228541223L;
	...
	private void loadTab(int n) {
		...
		ImageIcon planetIcon = new ImageIcon(getClass().getResource(
				title + ".gif"));
		...
		tabbedPane.setIconAt(n,
				new ImageIcon(getClass().getResource("red-ball.gif")));
	}
}
