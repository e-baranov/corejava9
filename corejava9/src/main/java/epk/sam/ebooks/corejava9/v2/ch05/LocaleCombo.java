...
public class LocaleCombo extends JComboBox<Locale> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -9120697187595833532L;
	...
	public ListCellRenderer<Locale> getRenderer() {
		if (renderer == null) {
			...
			final ListCellRenderer<Object> originalRenderer = (ListCellRenderer<Object>) super
					.getRenderer();
			if (originalRenderer == null)
				return null;
			renderer = new ListCellRenderer<Locale>() {
				public Component getListCellRendererComponent(
						JList<? extends Locale> list, Locale value, int index,
