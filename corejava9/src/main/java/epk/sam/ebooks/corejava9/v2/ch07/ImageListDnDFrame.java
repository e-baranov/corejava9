...
public class ImageListDnDFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4001929833064808874L;
	...
	public ImageListDnDFrame() {
		...
		list1 = new ImageList(Paths.get(getClass().getPackage().getName(),
				"images1"));
		list2 = new ImageList(Paths.get(getClass().getPackage().getName(),
				"images2"));
...
class ImageList extends JList<ImageIcon> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4154714505098310652L;
...
class ImageListTransferHandler extends TransferHandler {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4202386272164352016L;
