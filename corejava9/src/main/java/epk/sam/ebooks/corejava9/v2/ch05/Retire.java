package epk.sam.ebooks.corejava9.v2.ch05;
...
class RetireFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6012607970027016945L;
	...
	public RetireFrame() {
		...
		add(languageLabel, new GBCRetire(0, 0).setAnchor(GBCRetire.EAST));
		add(savingsLabel, new GBCRetire(0, 1).setAnchor(GBCRetire.EAST));
		add(contribLabel, new GBCRetire(2, 1).setAnchor(GBCRetire.EAST));
		add(incomeLabel, new GBCRetire(4, 1).setAnchor(GBCRetire.EAST));
		add(currentAgeLabel, new GBCRetire(0, 2).setAnchor(GBCRetire.EAST));
		add(retireAgeLabel, new GBCRetire(2, 2).setAnchor(GBCRetire.EAST));
		add(deathAgeLabel, new GBCRetire(4, 2).setAnchor(GBCRetire.EAST));
		add(inflationPercentLabel, new GBCRetire(0, 3).setAnchor(GBCRetire.EAST));
		add(investPercentLabel, new GBCRetire(2, 3).setAnchor(GBCRetire.EAST));
		add(localeCombo, new GBCRetire(1, 0, 3, 1));
		add(savingsField,
				new GBCRetire(1, 1).setWeight(100, 0).setFill(GBCRetire.HORIZONTAL));
		add(contribField,
				new GBCRetire(3, 1).setWeight(100, 0).setFill(GBCRetire.HORIZONTAL));
		add(incomeField, new GBCRetire(5, 1).setWeight(100, 0)
				.setFill(GBCRetire.HORIZONTAL));
		add(currentAgeField,
				new GBCRetire(1, 2).setWeight(100, 0).setFill(GBCRetire.HORIZONTAL));
		add(retireAgeField,
				new GBCRetire(3, 2).setWeight(100, 0).setFill(GBCRetire.HORIZONTAL));
		add(deathAgeField,
				new GBCRetire(5, 2).setWeight(100, 0).setFill(GBCRetire.HORIZONTAL));
		add(inflationPercentField,
				new GBCRetire(1, 3).setWeight(100, 0).setFill(GBCRetire.HORIZONTAL));
		add(investPercentField,
				new GBCRetire(3, 3).setWeight(100, 0).setFill(GBCRetire.HORIZONTAL));
		add(retireCanvas,
				new GBCRetire(0, 4, 4, 1).setWeight(100, 100).setFill(GBCRetire.BOTH));
		add(new JScrollPane(retireText), new GBCRetire(4, 4, 2, 1).setWeight(0, 100)
				.setFill(GBCRetire.BOTH));
		...
		add(computeButton, new GBCRetire(5, 3));
	...
	public void setCurrentLocale(Locale locale) {
		...
		resStrings = ResourceBundle.getBundle("retire.RetireStrings",
				currentLocale);
...
class RetireComponent extends JComponent {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 803438363758489583L;
