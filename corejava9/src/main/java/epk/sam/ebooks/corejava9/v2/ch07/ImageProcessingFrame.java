...
public class ImageProcessingFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4671799087217626171L;
	...
	public ImageProcessingFrame() {
		...
		add(new JComponent() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -8133759712834364253L;
		...
		sharpenItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				float[] elements = { 0.0f, -1.0f, 0.0f, -1.0f, 5.f, -1.0f,
						0.0f, -1.0f, 0.0f };
				convolve(elements);
			}
		});
		...
		edgeDetectItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				float[] elements = { 0.0f, -1.0f, 0.0f, -1.0f, 4.f, -1.0f,
						0.0f, -1.0f, 0.0f };
				convolve(elements);
			}
		});
		...
		rotateItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				AffineTransform transform = AffineTransform.getRotateInstance(
						Math.toRadians(5), image.getWidth() / 2,
						image.getHeight() / 2);
